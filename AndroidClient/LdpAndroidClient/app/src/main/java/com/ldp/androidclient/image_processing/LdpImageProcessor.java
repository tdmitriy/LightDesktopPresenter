package com.ldp.androidclient.image_processing;
...
public class LdpImageProcessor {
    ...
    private static int rmDesktopWidth = 0, rmDesktopHeight = 0;
    private final float scaleCoef;

    private Bitmap scaledScreen;
    private Bitmap origScreen;

    public LdpImageProcessor(int rmDWidth, int rmDHeight, float scaleCoef) {
        rmDesktopWidth = rmDWidth;
        rmDesktopHeight = rmDHeight;
    ...
    public static int getRemoteDesktopWidth() {
        return rmDesktopWidth;
    }

    public static int getRemoteDesktopHeight() {
